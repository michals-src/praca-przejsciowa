...
export default function Navbar() {
    return (
        <nav className="nawigacja">
            <ul>
              <li className="aktywny">
                <NavLink exact activeClassName="aktywny" to="/">
                  <div>
                    <span>
              ...
              <li>
                <NavLink activeClassName="aktywny" to="/woda">
                  <div>
                    <span>
                    ...
                    Zarządzenie podlewaniem
                  </div>
                </NavLink>
              </li>
              <li>
                <NavLink activeClassName="aktywny" to="/swiatlo">
                  <div>
                    <span>
